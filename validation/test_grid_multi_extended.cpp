/**
 * Multi-Instrument Grid Test - Extended to 2026.01.29
...
void LoadTickData() {
    ...
    std::string xauusd_file = "C:\\Users\\user\\Documents\\ctrader-backtest\\validation\\Grid\\XAUUSD_TICKS_2025_EXTENDED.csv";
    std::string xagusd_file = "C:\\Users\\user\\Documents\\ctrader-backtest\\validation\\XAGUSD\\XAGUSD_TICKS_2025_EXTENDED.csv";
...
int main() {
    std::cout << "=== Multi-Symbol Grid - Extended to 2026.01.29 ===" << std::endl;
    ...
    std::ofstream csv_out("grid_multi_extended_results.csv");
    ...
    csv_out.close();
    std::cout << "\nResults saved to: grid_multi_extended_results.csv" << std::endl;
