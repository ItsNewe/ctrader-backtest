...
int main() {
    std::cout << "=== 2024 Spacing Sweep ===" << std::endl;
    std::cout << std::endl;
    std::cout << "Spacing   Return   MaxDD%   Trades" << std::endl;
    ...
    for (double spacing : spacings) {
        ...
        tick_config.file_path = "C:\\Users\\user\\Documents\\ctrader-backtest\\validation\\Grid\\historical\\XAUUSD_TICKS_2024.csv";
    ...
    std::cout << std::endl;
    std::cout << "Compare to 2025:" << std::endl;
    std::cout << "2025 best: $0.25 -> 8.82x" << std::endl;
